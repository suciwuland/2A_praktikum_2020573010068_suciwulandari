    ...
    <div class="container-fluid em-1 mt-2">
        <div class="row">
            ...
            <div class="col-9 ">
                ...
                if ($row['level'] == 'admin') {
                ?>
                    <button style="background-color:lightsteelblue; color: black;" type="button" class="btn btn-primary mb-3 mt-2" data-bs-toggle="modal" data-bs-target="#ModalTambah">Tambah Data Mahasiswa</button>
                    <!-- modal tambah -->
